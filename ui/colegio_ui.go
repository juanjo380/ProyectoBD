...
func BuildEditarColegioUI(w fyne.Window, c *models.Colegio) fyne.CanvasObject {
	...
	return container.NewVBox(
		widget.NewLabel(fmt.Sprintf("Editando Colegio ID: %d", func() int { id, _ := strconv.Atoi(c.IDColegio); return id }())),
		form,
	)
}
